...
class ThemeTypographyData extends TextTheme {
  ...
  ThemeTypographyData.fromColors(ThemeColorsData colors)
      : super(
          displayLarge: _montserratBaseTextStyle.copyWith(
            fontSize: 60,
            height: 1.12,
            letterSpacing: 0,
            color: colors.text,
          ),
          displayMedium: _montserratBaseTextStyle.copyWith(
            fontSize: 46,
            height: 1.3,
          ...
          displaySmall: _montserratBaseTextStyle.copyWith(
            fontSize: 36,
            height: 1.22,
            letterSpacing: 0,
            color: colors.text,
          ),
          headlineLarge: _montserratBaseTextStyle.copyWith(
            fontSize: 32,
            height: 1.25,
            letterSpacing: 0,
            color: colors.text,
          ),
          headlineMedium: _montserratBaseTextStyle.copyWith(
            fontSize: 28,
            height: 1.128,
            letterSpacing: 0,
            color: colors.text,
          ),
          headlineSmall: _montserratBaseTextStyle.copyWith(
            fontSize: 30,
            height: 1.3,
            letterSpacing: 0,
          ...
          titleLarge: _montserratBaseTextStyle.copyWith(
            fontSize: 24,
            height: 1.27,
            letterSpacing: 0,
            color: colors.text,
          ...
          titleMedium: _montserratBlackBaseTextStyle.copyWith(
            fontSize: 20,
            height: 1.3,
            letterSpacing: 0.15,
            color: colors.text,
          ...
          titleSmall: _montserratBaseTextStyle.copyWith(
            fontSize: 16,
            height: 1.3,
            letterSpacing: 0.1,
            color: colors.text,
          ...
          bodyLarge: _montserratBaseTextStyle.copyWith(
            fontSize: 16,
            height: 1.5,
            letterSpacing: 0.15,
            color: colors.text,
          ),
          bodyMedium: _montserratBaseTextStyle.copyWith(
            fontSize: 14,
            height: 1.5,
            letterSpacing: 0.25,
            color: colors.text,
          ),
          bodySmall: _montserratBaseTextStyle.copyWith(
            fontSize: 12,
            height: 1.33,
            letterSpacing: 0.4,
            color: colors.text,
          ),
          labelLarge: _montserratBaseTextStyle.copyWith(
            fontSize: 14,
            height: 1.43,
            letterSpacing: 0.1,
            color: colors.text,
          ...
          labelMedium: _montserratBaseTextStyle.copyWith(
            fontSize: 12,
            height: 1.33,
            letterSpacing: 0.5,
            color: colors.text,
          ...
          labelSmall: _montserratBaseTextStyle.copyWith(
            fontSize: 11,
            height: 1.45,
            letterSpacing: 0.5,
            color: colors.text,
